...
/**
 * Thrown when the supplied geometry is not valid in the context in which it is used.
 *
...
public final class InvalidGeometryException extends RuntimeException {
    ...
    /** Constructs a new InvalidGeometryException with the specified detail message.
